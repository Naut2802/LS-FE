...
export const students = [
  ...
  { id: 2, name: 'Nguyễn Huynh Gia Gia', image: GiaGiaImg, class: 'Lớp Kindy 1' },
  { id: 3, name: 'Lê Hoàng Nam', image: HoangNamImg, class: 'Lớp Kindy 1' },
  { id: 4, name: 'Nguyễn Cát Bảo Ngọc', image: BaoNgocImg, class: 'Lớp Kindy 1' },
  { id: 5, name: 'Minh Châu', image: MinhChauImg, class: 'Lớp Kindy 1' },
  { id: 6, name: 'Khả Doanh', image: KhaDoanh, class: 'Lớp Kindy 1' }
]